...
namespace ClassLibraryPassword.Tests
{
    ...
    public class PasswordCheckerTests
    {
        ...
        {
            // Arrange
            string password = "Glist!zabivnoi2004";
            bool expected = true;
            // Act
        ...
        [TestMethod()]
        public void Check_20SpecialSymbols_ReturnsFalse()
        {
            // Arrange
            string password = "qwert$$$$dijeurrhjlfllfj";
            bool expected = false;
            // Act
            bool actual = PasswordChecker.validatePassword(password);
            // Assert
